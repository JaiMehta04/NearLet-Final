        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                  Text('Jalaram Super Store',
                      style: Theme.of(context).textTheme.subtitle2),
                  UIHelper.verticalSpaceExtraSmall(),
                  Text('Kisan Samosa Gali',
          ...
          Row(
            children: <Widget>[
              ...
              Flexible(
                child: Text(
                  'Notes for all Subjects of sem-6 IT(pack of 5)',
                  style: Theme.of(context).textTheme.bodyText1,
                ),
              ),
              UIHelper.horizontalSpaceSmall(),
        ...
        children: <Widget>[
          ...
          Row(
            ...
            children: <Widget>[
              ...
              Text('Rs 1129.00', style: textStyle),
            ],
          ),
          UIHelper.verticalSpaceMedium(),
          Row(
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                const Spacer(),
                Text('Rs 1209.67', style: textStyle),
              ],
            ),
          ),
        ],
