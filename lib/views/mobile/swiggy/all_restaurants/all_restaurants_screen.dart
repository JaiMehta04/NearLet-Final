...
import 'package:swiggy_ui/models/all_shop.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    _RestaurantHorizontalListView(
                      ...
                      restaurants: AllShop.getIndianRestaurants(),
                    ),
                    _RestaurantListView(
                    ...
                    _RestaurantHorizontalListView(
                      ...
                      restaurants: AllShop.getPopularBrands(),
                    ),
                    _RestaurantListView(
...
class _FoodHorizontalListView extends StatelessWidget {
  final restaurants = AllShop.getPopularBrands();
...
class _CategoriesView extends StatelessWidget {
  final categories = AllShop.getPopularTypes();
...
class _RestaurantListView extends StatelessWidget {
  ...
  final List<SpotlightBestTopGrocery> restaurants;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: restaurants.length,
        itemBuilder: (context, index) => SearchProductListItemView(
