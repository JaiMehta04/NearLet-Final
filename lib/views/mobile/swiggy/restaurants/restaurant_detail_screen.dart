...
import 'package:swiggy_ui/models/shop_details.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Column(
                  children: <Widget>[
                    _buildOfferTile(
                        context, '30% off up to Rs75 | Use code NearLetIT'),
          ...
          _FoodListView(
            title: 'Stationary',
            foods: ShopDetail.getBreakfast(),
          ),
          const CustomDividerView(dividerHeight: 15.0),
          _FoodListView(
            title: 'All Time Favourite',
            foods: ShopDetail.getAllTimeFavFoods(),
          ),
          const CustomDividerView(dividerHeight: 15.0),
          _FoodListView(
            title: 'Other Items',
...
class _RecommendedFoodView extends StatelessWidget {
  final foods = ShopDetail.getBreakfast();
