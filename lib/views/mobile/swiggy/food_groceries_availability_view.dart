              ...
              children: <Widget>[
                ...
                Flexible(
                  child: Column(
                    children: <Widget>[
                      Text(
                        'We are now deliverying Stationeries and other essentials.',
                        style: Theme.of(context).textTheme.headline4,
                      ),
                      UIHelper.verticalSpaceSmall(),
                      Text(
                        'Grocery & Genie service (Mon-Sat)-6:00 am to 9:00pm. Groceries & Stationery (Mon-Sat)-6:00 am to 6:00pm. Dairy (Mon-Sat)-6:00 am to 6:00pm (Sun)-6:00 am to 12:00 pm',
